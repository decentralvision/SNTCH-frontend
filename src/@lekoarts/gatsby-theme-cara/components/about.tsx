...
const About = ({ offset, factor = 1 }: { offset: number; factor?: number }) => (
  <div>
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      <UpDown>
        <Svg icon="circle" hiddenMobile width={6} color="icon_blue" left="50%" top="75%" />
        ...
        <Svg icon="circle" hiddenMobile width={24} color="icon_orange" left="80%" top="80%" />
      </UpDown>
      <UpDownWide>
        <Svg icon="circle" hiddenMobile width={16} color="icon_purple" left="5%" top="80%" />
